export default function Discover(){
    return(
        <div className="w-full flex justify-between h-fit my-12 items-center">
            <h1 className="font-medium text-5xl font-ply w-[70%]">Expert guidance and solutions for your project stages</h1>
